...
(function ($) {
    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' +
                           '<div class="Card-picture">' +
                               '<a href="' + book.slug + '">' + '<img src="' + book.image + '" alt="cover.png">' + '</a>' +
                           ...
                           '<div class="Card-content">' +
                               '<strong class="Card-title"><a href="' + book.slug + '">' + book.title + '</a>' + '</strong>' +
            ...
            var userTemplate = function (user) {
                return '<tr>' +
                           ...
                           '<td>' + user.balance + '</td>' +
                           '<td>' +
                               '<a class="btn btn btn_primary btn_outline trigger" style="padding:0 0 0 10px;display:inline-flex" href="#gift-' + user.id + '" title="' + $("#gift-msg").val() + '">' +
                                   '<span class="btn-icon"><img src="/assets/img/icons/myBook1.svg" alt="myBook1.svg"></span>' +
                               '</a>\n' +
                               '<div id="gift-' + user.id + '" class="modal modal_compression" style="background-color:rgba(0,0,0,.3)">' +
                                   '<div class="modal-window">' +
                                       '<a class="modal-close" href="#"><span></span><span></span></a>' +
                                       '<form method="post" style="display:inline-block">' +
                                           '<strong class="modal-title">' + $("#book-slug-msg").val() + '</strong>' +
                                           ...
                                           '<button class="btn btn btn_primary">' +
                                               '<span class="btn-content">' + $("#gift-msg").val() + '</span>' +
                                           '</button>' +
                                       '</form>' +
                                   '</div>' +
                               '</div>\n' +
                               '<form method="post" style="display:inline-block">' +
                                   ...
                                   '<button class="btn btn_primary btn_outline" style="padding:0 0 0 10px" type="submit" title="' + $("#set-admin-msg").val() + '">' +
                               ...
                               '<form method="post" style="display:inline-block">' +
                                   ...
                                   '<button class="btn btn_danger btn_outline" style="padding:0 0 0 10px" type="submit" title="' + $("#delete-msg").val() + '">' +
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        function getData(address, data, type) {
                            ...
                            $.ajax({
                                ...
                                complete: function (result) {
                                    if (result.status === 200) {
                                        var data = '';
                                        if (address.startsWith('/users/')) {
                                            result.responseJSON.users.forEach(function (user) {
                                                data += userTemplate(user);
                                            });
                                        ...
                                        $this.data('refreshoffset', $this.data('refreshoffset') + 1);
                                        $(".Cards-footer .btn.btn_primary")[($this.data('refreshoffset') * $this.data('refreshlimit') >= result.responseJSON.count) ? "hide" : "show"]();
                        ...
                        switch (data) {
                            case'changedate':
                                if (e.type === 'change') {
                                    ...
                                    if (!$this.hasClass('form-input_date_uninit')) {
                                        ...
                                        $(".Cards-footer .btn.btn_primary").data('refreshoffset', 1)
                            ...
                            case'search':
                                ...
                                break;
                            case'users':
                                getData('/users/' + $this.data('refreshquery'), {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/rateBookReview', data, function (result) {
                            if (result != null && result.result) {
                                if ($this.data('btnradio')) {
                                    $('[data-btnradio="' + $this.data('btnradio') + '"]').each(function (e) {
                                        if ($(this).data('check') && !$(this).is($this)) {
                                            $(this).find('.btn-content').text(parseFloat($(this).find('.btn-content').text()) - 1);
                                        }
                                    });
                                }
                                if ($this.data('check')) {
                                ...
                                //$("#err_dialog").dialog();
                                $this.parent().append('<div class="form-error">' + result.error + '</div>');
                            }
                        });
                    });
                }
        ...
        var Login = function () {
            ...
            var $entryButton = $('button[name="toComeInPhone"], button[name="toComeInMail"], button[name="toComeInPass"]');
                ...
                init: function () {
                    ...
                    $('#submitPhone').on('click', function () {
                        var $this = $(this), $row = $this.closest('.form-group_row'),
                            data = {contact: $row.find('.form-input_phone').val(), type: $this.data('type')};
                        postData('/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">' + (result.message || 'Вам направлен код подтверждения по SMS') + '</div>')
                    ...
                    $('#submitMail').on('click', function () {
                        var $this = $(this), $row = $this.closest('.form-group_row'),
                            data = {contact: $row.find('.form-input_mail').val(), type: $this.data('type')};
                        postData('/requestContactConfirmation', data, function (result) {
                            if (result.result) {
                                $this.after('<div class="form-info">' + (result.message || 'Вам направлен код подтверждения в письме на почту') + '</div>')
                                $this.attr('disabled', 'disabled');
                                $row.addClass('form-group_confirm');
                                $row.find('.form-error').remove();
                            } else {
                        ...
                        if (!$this.hasClass('form-input_error')) {
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    $but.after('<div class="form-info">' + (result.message || 'Код успешно подтвержден') + '</div>');
                                    $this.trigger('change');
                                } else {
                                    if (result) {
                        ...
                        if ($this.attr("name") === 'typeauth') {
                            switch ($this.val()) {
                                case'phonetype':
                                    ...
                                    $pass.addClass('form-input_hide').prop('disabled', true);
                                ...
                                case'mailtype':
                                    ...
                                    break;
                                case'passtype':
                                    $pass.removeClass('form-input_hide').prop('disabled', false);
                                    $phone.addClass('form-input_hide').prop('disabled', true);
                                    $mail.addClass('form-input_hide').prop('disabled', true);
                                    $sendButton.data('type', 'pass');
                                    break;
                            }
                        }
                    });
                    ...
                    $sendButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            var contact = $thisStep.find('.form-input_phone, .form-input_mail, .form-input_pass').not('.form-input_hide').val();
                            $this.data('send', {contact: contact, type: $this.data('type')});
                            if (!error) {
                                postData('/requestContactConfirmation', $this.data('send'), function (result) {
                                    if (result.result) {
                                        ...
                                        $LoginStep.find('[data-send]').data('send', {contact: contact, type: $this.data('type')});
                                        switch ($this.data('type')) {
                                            ...
                                            case'mail':
                                                ...
                                                break;
                                            case'pass':
                                                $LoginStep.filter('[data-type="pass"]').removeClass('Login-step_hide');
                                                break;
                                        }
                                    } else {
                    ...
                    $entryButton.on('click', function (e) {
                        ...
                        if ($this.is('[data-send]')) {
                            var code = $thisStep.find('[name="phonecode"], [name="mailcode"], [name="password"]').not('.form-input_hide').val();
                            var send = $this.data('send');
                            $this.data('send', {code: code, contact: send.contact, type: send.type});
                            if (!error) {
                ...
                init: function () {
                                ...
                                if (result.result) {
                                    ...
                                    if ($cart.length) {
                                        ...
                                        $cart.find('.Cart-product').each(function () {
                                            var $this = $(this);
                                            price += parseFloat($this.find('.Cart-price:not(.Cart-price_old)').text().replace(/\D+/g, '')) || 0;
                                            priceOld += parseFloat($this.find('.Cart-price_old').text().replace(/\D+/g, '')) || 0;
                                            booksId.push($this.find('[data-sendstatus="CART"]').data('bookid'));
                                        });
                                        $cart.find('.Cart-total .Cart-price').not('.Cart-price_old').text('₽' + price);
                                        if (priceOld) {
                                            $cart.find('.Cart-total .Cart-price_old').text('₽' + priceOld);
                                        }
                                        else {
                                            $cart.find('.Cart-total .Cart-price_old').remove();
                                        }
                                        if ($cart.hasClass('Cart_postponed')) {
                                            $cart.find('.Cart-buyAll').data('bookid', booksId);
                                        }
                                        if (!$cart.find('.Cart-product').length) {
                                            $cart.prepend('<div class="Cart-messageInfo">' + $('h1.Middle-title').data('empty') + '</div>');
                                    ...
                                    $("#postponed-counter").text(result.keptCounter);
                                    $("#cart-counter").text(result.cartCounter);
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/rateBook', {
                            ...
                            if (result.result) {
                                $title.addClass('Rating-title_success').text(result.message || 'Рейтинг успешно изменен');
                            } else {
                                $title.addClass('Rating-title_error').text(result.error || 'Возникла ошибка');
            ...
            return {
                init: function () {
                    $('form.Topup').on('submit', function (e) {
                        var $this = $(this);
                        $this.parent().find('.form-error').remove();
                        $this.find('[name="sum"]').removeClass('form-input_error');
                        e.preventDefault();
                        Login().postData('/payment', {
                            ...
                            if (result.result) {
                                ...
                                $this.find('[name="sum"]').addClass('form-input_error').parent().after('<div class="form-error">' + result.error + '</div>');
                            }
                        })
                    });
                }
        ...
        var Transactions = function () {
            var transactionTemplate = function (transaction) {
                return '<tr>' +
                    ...
                    '<td><span class="Transactions_textSuccess"><strong>' + transaction.value + '</strong></span></td>' +
                    '<td>' + transaction.description + '</td>' +
                    '</tr>';
            }

            function getData(address, data, $that) {
                var scroll = $(window).scrollTop();
                $.ajax({
                    url: '/api' + address,
                    type: 'GET',
                    ...
                    complete: function (result) {
                        if (result.status === 200) {
                            $that.data('transactionoffset', ++data.offset);
                            var rows = '';
                            result.responseJSON.transactions.forEach(function (transaction) {
                                rows += transactionTemplate(transaction);
                            });
                            $('.Transactions tbody').append(rows);
                            $(".btn.btn_primary.Transactions-get")[(data.offset * data.limit >= result.responseJSON.count) ? "hide" : "show"]();
                            $(window).scrollTop(scroll);
                        }
                        else {
                            alert('Ошибка ' + result.status);
    ...
    $("#locales").change(function() {
        ...
        document.cookie = "lang=" + $(this).val() + "; expires=" + date.toUTCString() + "; path=/";
        window.location.reload();
    });

    $("#cloud-spoiler-btn").click(function(e){
        e.preventDefault();
        var $this = $(this);
        var scroll = $(window).scrollTop();
        var $spoiler = $("#cloud-spoiler");
        if ($spoiler.hasClass('Spoiler_CLOSE')) {
            $spoiler.removeClass('Spoiler_CLOSE');
            $this.text($this.data("hidetext"));
            $(window).scrollTop(scroll);
        }
        else {
            $spoiler.addClass('Spoiler_CLOSE');
